# Audit coherence 0.7.2-beta

OuInPo Suite 0.7.2-beta est une beta technique. Elle peut etre partagee pour test encadre, mais ne doit pas etre presentee comme une version stable.

## Architecture actuelle

- `ouinpo-suite.php` charge l'autoloader, declare la version `0.7.2-beta` et boote la suite sur `plugins_loaded`.
