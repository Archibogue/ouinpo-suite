...
Ce dossier contient uniquement les packs JSON distribues avec OuInPo Suite `0.7.3-beta`, plus le schema de reference `ouinpo-pack.schema.json`.
...
Le champ `schema_version` reste `"1.0"` pour la version `0.7.3-beta`.
