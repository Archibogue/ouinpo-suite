...
class Ouinpo_Submissions_Plugin {
    ...
    /* Liste simple */
    .ouinpo-list{list-style:disc;padding-left:1.25rem}
    .ouinpo-badge{
    ...
    /* Titres de section (Cours / TP / Projets…) */
    .ouinpo-section{margin:1rem 0}
    .ouinpo-section h4{
    ...
    /* Filtres domaines (menu déroulant) */
    .ouinpo-res-filters{
    ...
    .ouinpo-chapter-title{
      margin:0 0 .5rem 0;
      font-size:1.15rem;
      font-weight:bold;
    }
    
    /* Domaine sans taxonomie associée */
    .ouinpo-chapter[data-domain="no-domain"] .ouinpo-chapter-title{
      opacity:.8;
      font-style:italic;
    }
    
    /* Description de la ressource (contenu WP) */
    .ouinpo-res-desc{
    ...
    .ouinpo-files-list li{
      margin:.1rem 0;
    }';
        wp_register_style('ouinpo-inline', false);
        wp_enqueue_style('ouinpo-inline');
        wp_add_inline_style('ouinpo-inline', $css);
    }
    ...
    public function admin_assets($hook){
        ...
        if (in_array($ptype, array(self::CPT_RESOURCE), true)) {
            ...
            wp_enqueue_script('ouinpo-admin');
            ...
            jQuery(function($){
              ...
              dz.on('dragenter dragover', function(e){
                e.preventDefault(); e.stopPropagation(); highlight(true);
              });
            ...
            ";
            wp_add_inline_script('ouinpo-admin', $js);
        }
    }
    ...
    public function notif_bootstrap_footer() {
        ...
        $seg_phrase = self::segfault_random_phrase();
        ?>
<style>
  .ouinpo-notif-float{
