...
class AssessmentsRoutes {
    ...
    public static function register() {
        register_rest_route(self::NS, '/assessments', [
            ['methods'=>'GET','callback'=>[__CLASS__,'list'],'permission_callback'=>function(){return current_user_can('edit_posts');}],
            ['methods'=>'POST','callback'=>[__CLASS__,'create'],'permission_callback'=>function(){return current_user_can('edit_posts');}],
        ]);
        register_rest_route(self::NS, '/assessments/(?P<id>\d+)', [
            ['methods'=>'GET','callback'=>[__CLASS__,'get'],'permission_callback'=>function(){return current_user_can('edit_posts');}],
            ['methods'=>'POST','callback'=>[__CLASS__,'grade'],'permission_callback'=>function(){return current_user_can('edit_posts');}],
        ]);
    }
