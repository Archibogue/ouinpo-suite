...
final class AttemptAdvice
{
    ...
    public static function generate(string $markdown): string
    {
        ...
        $key = 'ouinpo_ticket_advice_' . hash('sha256', 'v3-b12-free-text|' . get_current_user_id() . '|' . $context);
...
Si un ticket a été remis à zéro, les événements précédant sa dernière remise à zéro sont des essais antérieurs. Ne les présente pas comme des actions ou preuves du traitement actuel. Tu peux commenter la progression entre essais en les distinguant explicitement.
